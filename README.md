...
This React single-page a1111pp lets you enter an employee number and name, saves the entry to a local Postgres database through a small Node API, and shows the saved row.
